class Setting < ApplicationRecord
  ...
  class << self
    ...
    def defaults
      {
        ...
        "twitter_hashtag": nil,
        "youtube_handle": nil,
	"url": "http://consul.citizen-life.com", # Public-facing URL of the app.
        # CONSUL installation's organization name
        "org_name": "Citizen Life Powered by CONSUL",
        "meta_title": nil,
	...
	"mailer_from_address": "pedro.figueroa@ignition-digital.org",
